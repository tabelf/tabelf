...
func UploadStationImageHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UploadStationImageRequest
		...
		l := station.NewUploadStationImageLogic(r.Context(), ctx)
		resp, err := l.UploadStationImage(&req)
		if err != nil {
