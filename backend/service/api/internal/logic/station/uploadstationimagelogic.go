...
type UploadStationImageLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewUploadStationImageLogic(ctx context.Context, svcCtx *svc.ServiceContext) *UploadStationImageLogic {
	return &UploadStationImageLogic{
...
func (l *UploadStationImageLogic) UploadStationImage(req *types.UploadStationImageRequest) (resp *types.UploadStationImageResponse, err error) {
	...
	u, _ := url.Parse(app.TxCosStationURL)
	...
	return &types.UploadStationImageResponse{
		ImageURL: app.TxCosStationURL + "/" + imageName,
	}, nil
}
