...
func (wq *WorkspaceQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (wq *WorkspaceQuery) FirstIDX(ctx context.Context) uint64 {
...
func (wq *WorkspaceQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (wq *WorkspaceQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (wq *WorkspaceQuery) IDs(ctx context.Context) ([]uint64, error) {
	var ids []uint64
...
func (wq *WorkspaceQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := wq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (wgb *WorkspaceGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(wgb.fields) > 1 {
		return nil, errors.New("entschema: WorkspaceGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := wgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (wgb *WorkspaceGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{workspace.Label}
	default:
		err = fmt.Errorf("entschema: WorkspaceGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (wgb *WorkspaceGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(wgb.fields) > 1 {
		return nil, errors.New("entschema: WorkspaceGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := wgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (wgb *WorkspaceGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{workspace.Label}
	default:
		err = fmt.Errorf("entschema: WorkspaceGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (wgb *WorkspaceGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(wgb.fields) > 1 {
		return nil, errors.New("entschema: WorkspaceGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := wgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (wgb *WorkspaceGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{workspace.Label}
	default:
		err = fmt.Errorf("entschema: WorkspaceGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (wgb *WorkspaceGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(wgb.fields) > 1 {
		return nil, errors.New("entschema: WorkspaceGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := wgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (wgb *WorkspaceGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{workspace.Label}
	default:
		err = fmt.Errorf("entschema: WorkspaceGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ws *WorkspaceSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ws.fields) > 1 {
		return nil, errors.New("entschema: WorkspaceSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ws.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ws *WorkspaceSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{workspace.Label}
	default:
		err = fmt.Errorf("entschema: WorkspaceSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ws *WorkspaceSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ws.fields) > 1 {
		return nil, errors.New("entschema: WorkspaceSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ws.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ws *WorkspaceSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{workspace.Label}
	default:
		err = fmt.Errorf("entschema: WorkspaceSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ws *WorkspaceSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ws.fields) > 1 {
		return nil, errors.New("entschema: WorkspaceSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ws.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ws *WorkspaceSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{workspace.Label}
	default:
		err = fmt.Errorf("entschema: WorkspaceSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ws *WorkspaceSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ws.fields) > 1 {
		return nil, errors.New("entschema: WorkspaceSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ws.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ws *WorkspaceSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{workspace.Label}
	default:
		err = fmt.Errorf("entschema: WorkspaceSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
