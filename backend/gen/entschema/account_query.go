...
func (aq *AccountQuery) IDs(ctx context.Context) ([]uint64, error) {
	var ids []uint64
...
func (agb *AccountGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(agb.fields) > 1 {
		return nil, errors.New("entschema: AccountGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := agb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (agb *AccountGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{account.Label}
	default:
		err = fmt.Errorf("entschema: AccountGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (agb *AccountGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(agb.fields) > 1 {
		return nil, errors.New("entschema: AccountGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := agb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (agb *AccountGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{account.Label}
	default:
		err = fmt.Errorf("entschema: AccountGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (agb *AccountGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(agb.fields) > 1 {
		return nil, errors.New("entschema: AccountGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := agb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (agb *AccountGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{account.Label}
	default:
		err = fmt.Errorf("entschema: AccountGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (agb *AccountGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(agb.fields) > 1 {
		return nil, errors.New("entschema: AccountGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := agb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (agb *AccountGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{account.Label}
	default:
		err = fmt.Errorf("entschema: AccountGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (as *AccountSelect) Strings(ctx context.Context) ([]string, error) {
	if len(as.fields) > 1 {
		return nil, errors.New("entschema: AccountSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := as.Scan(ctx, &v); err != nil {
		return nil, err
...
func (as *AccountSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{account.Label}
	default:
		err = fmt.Errorf("entschema: AccountSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (as *AccountSelect) Ints(ctx context.Context) ([]int, error) {
	if len(as.fields) > 1 {
		return nil, errors.New("entschema: AccountSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := as.Scan(ctx, &v); err != nil {
		return nil, err
...
func (as *AccountSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{account.Label}
	default:
		err = fmt.Errorf("entschema: AccountSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (as *AccountSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(as.fields) > 1 {
		return nil, errors.New("entschema: AccountSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := as.Scan(ctx, &v); err != nil {
		return nil, err
...
func (as *AccountSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{account.Label}
	default:
		err = fmt.Errorf("entschema: AccountSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (as *AccountSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(as.fields) > 1 {
		return nil, errors.New("entschema: AccountSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := as.Scan(ctx, &v); err != nil {
		return nil, err
...
func (as *AccountSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{account.Label}
	default:
		err = fmt.Errorf("entschema: AccountSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
