...
func (sq *StationQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (sq *StationQuery) FirstIDX(ctx context.Context) uint64 {
...
// Returns a *NotSingularError when exactly one Station entity is not found.
...
// Returns a *NotSingularError when exactly one Station ID is not found.
// Returns a *NotFoundError when no entities are found.
func (sq *StationQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (sq *StationQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (sq *StationQuery) IDs(ctx context.Context) ([]uint64, error) {
	var ids []uint64
...
func (sq *StationQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (sgb *StationGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("entschema: StationGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *StationGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{station.Label}
	default:
		err = fmt.Errorf("entschema: StationGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *StationGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("entschema: StationGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *StationGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{station.Label}
	default:
		err = fmt.Errorf("entschema: StationGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *StationGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("entschema: StationGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *StationGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{station.Label}
	default:
		err = fmt.Errorf("entschema: StationGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *StationGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("entschema: StationGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *StationGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{station.Label}
	default:
		err = fmt.Errorf("entschema: StationGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *StationSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("entschema: StationSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *StationSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{station.Label}
	default:
		err = fmt.Errorf("entschema: StationSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *StationSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("entschema: StationSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *StationSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{station.Label}
	default:
		err = fmt.Errorf("entschema: StationSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *StationSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("entschema: StationSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *StationSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{station.Label}
	default:
		err = fmt.Errorf("entschema: StationSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *StationSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("entschema: StationSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *StationSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{station.Label}
	default:
		err = fmt.Errorf("entschema: StationSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
