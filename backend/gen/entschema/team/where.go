...
func ID(id uint64) predicate.Team {
...
func IDEQ(id uint64) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id uint64) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func IDIn(ids ...uint64) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func IDNotIn(ids ...uint64) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id uint64) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func IDGTE(id uint64) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func IDLT(id uint64) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func IDLTE(id uint64) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func UID(v string) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func DeactivatedAt(v time.Time) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func ExpiredAt(v time.Time) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func UIDEQ(v string) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldUID), v))
	})
}
...
func UIDNEQ(v string) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func UIDIn(vs ...string) predicate.Team {
...
func UIDNotIn(vs ...string) predicate.Team {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UIDGT(v string) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func UIDGTE(v string) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func UIDLT(v string) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func UIDLTE(v string) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func UIDContains(v string) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func UIDHasPrefix(v string) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func UIDHasSuffix(v string) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func UIDEqualFold(v string) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func UIDContainsFold(v string) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func DeactivatedAtEQ(v time.Time) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldDeactivatedAt), v))
	})
}
...
func DeactivatedAtNEQ(v time.Time) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func DeactivatedAtIn(vs ...time.Time) predicate.Team {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func DeactivatedAtNotIn(vs ...time.Time) predicate.Team {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func DeactivatedAtGT(v time.Time) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func DeactivatedAtGTE(v time.Time) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func DeactivatedAtLT(v time.Time) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func DeactivatedAtLTE(v time.Time) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func DeactivatedAtIsNil() predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func DeactivatedAtNotNil() predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func ExpiredAtEQ(v time.Time) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldExpiredAt), v))
	})
}
...
func ExpiredAtNEQ(v time.Time) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func ExpiredAtIn(vs ...time.Time) predicate.Team {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ExpiredAtNotIn(vs ...time.Time) predicate.Team {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ExpiredAtGT(v time.Time) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func ExpiredAtGTE(v time.Time) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func ExpiredAtLT(v time.Time) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func ExpiredAtLTE(v time.Time) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
