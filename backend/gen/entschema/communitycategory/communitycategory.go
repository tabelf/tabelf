...
const (
	// Label holds the string label denoting the communitycategory type in the database.
	...
	// Table holds the table name of the communitycategory in the database.
	Table = "community_category"
)

// Columns holds all SQL columns for communitycategory fields.
var Columns = []string{
	FieldID,
	FieldUID,
	FieldCreatedAt,
