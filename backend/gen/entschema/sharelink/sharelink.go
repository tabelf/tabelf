...
const (
	...
	// FieldValidDay holds the string denoting the valid_day field in the database.
	FieldValidDay = "valid_day"
	// FieldExpiredAt holds the string denoting the expired_at field in the database.
	FieldExpiredAt = "expired_at"
	// FieldRecentAt holds the string denoting the recent_at field in the database.
	FieldRecentAt = "recent_at"
