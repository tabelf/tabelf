...
func (*Admin) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case admin.FieldUID, admin.FieldUserUID:
			values[i] = new(sql.NullString)
		case admin.FieldCreatedAt, admin.FieldUpdatedAt, admin.FieldDeactivatedAt:
...
func (a *Admin) Unwrap() *Admin {
	...
	if !ok {
		panic("entschema: Admin is not a transactional entity")
	}
