...
const (
	...
	// FieldReferralUID holds the string denoting the referral_uid field in the database.
	FieldReferralUID = "referral_uid"
	// FieldRefereeUID holds the string denoting the referee_uid field in the database.
	FieldRefereeUID = "referee_uid"
