...
func (ngb *NoticeGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(ngb.fields) > 1 {
		return nil, errors.New("entschema: NoticeGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := ngb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ngb *NoticeGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{notice.Label}
	default:
		err = fmt.Errorf("entschema: NoticeGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ngb *NoticeGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(ngb.fields) > 1 {
		return nil, errors.New("entschema: NoticeGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := ngb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ngb *NoticeGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{notice.Label}
	default:
		err = fmt.Errorf("entschema: NoticeGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ngb *NoticeGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(ngb.fields) > 1 {
		return nil, errors.New("entschema: NoticeGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := ngb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ngb *NoticeGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{notice.Label}
	default:
		err = fmt.Errorf("entschema: NoticeGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ngb *NoticeGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(ngb.fields) > 1 {
		return nil, errors.New("entschema: NoticeGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := ngb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ngb *NoticeGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{notice.Label}
	default:
		err = fmt.Errorf("entschema: NoticeGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ns *NoticeSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ns.fields) > 1 {
		return nil, errors.New("entschema: NoticeSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ns.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ns *NoticeSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{notice.Label}
	default:
		err = fmt.Errorf("entschema: NoticeSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ns *NoticeSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ns.fields) > 1 {
		return nil, errors.New("entschema: NoticeSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ns.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ns *NoticeSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{notice.Label}
	default:
		err = fmt.Errorf("entschema: NoticeSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ns *NoticeSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ns.fields) > 1 {
		return nil, errors.New("entschema: NoticeSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ns.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ns *NoticeSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{notice.Label}
	default:
		err = fmt.Errorf("entschema: NoticeSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ns *NoticeSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ns.fields) > 1 {
		return nil, errors.New("entschema: NoticeSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ns.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ns *NoticeSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{notice.Label}
	default:
		err = fmt.Errorf("entschema: NoticeSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
