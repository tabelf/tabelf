...
func (mgb *MessageGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(mgb.fields) > 1 {
		return nil, errors.New("entschema: MessageGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := mgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (mgb *MessageGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{message.Label}
	default:
		err = fmt.Errorf("entschema: MessageGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (mgb *MessageGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(mgb.fields) > 1 {
		return nil, errors.New("entschema: MessageGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := mgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (mgb *MessageGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{message.Label}
	default:
		err = fmt.Errorf("entschema: MessageGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (mgb *MessageGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(mgb.fields) > 1 {
		return nil, errors.New("entschema: MessageGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := mgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (mgb *MessageGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{message.Label}
	default:
		err = fmt.Errorf("entschema: MessageGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (mgb *MessageGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(mgb.fields) > 1 {
		return nil, errors.New("entschema: MessageGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := mgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (mgb *MessageGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{message.Label}
	default:
		err = fmt.Errorf("entschema: MessageGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ms *MessageSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ms.fields) > 1 {
		return nil, errors.New("entschema: MessageSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ms.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ms *MessageSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{message.Label}
	default:
		err = fmt.Errorf("entschema: MessageSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ms *MessageSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ms.fields) > 1 {
		return nil, errors.New("entschema: MessageSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ms.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ms *MessageSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{message.Label}
	default:
		err = fmt.Errorf("entschema: MessageSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ms *MessageSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ms.fields) > 1 {
		return nil, errors.New("entschema: MessageSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ms.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ms *MessageSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{message.Label}
	default:
		err = fmt.Errorf("entschema: MessageSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ms *MessageSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ms.fields) > 1 {
		return nil, errors.New("entschema: MessageSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ms.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ms *MessageSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{message.Label}
	default:
		err = fmt.Errorf("entschema: MessageSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
