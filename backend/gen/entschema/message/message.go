...
const (
	...
	// FieldPromoterUID holds the string denoting the promoter_uid field in the database.
	FieldPromoterUID = "promoter_uid"
	// FieldCategory holds the string denoting the category field in the database.
	FieldCategory = "category"
	// FieldDescription holds the string denoting the description field in the database.
	FieldDescription = "description"
	// FieldHasRead holds the string denoting the has_read field in the database.
	FieldHasRead = "has_read"
...
var (
	...
	// DefaultHasRead holds the default value on creation for the "has_read" field.
	DefaultHasRead bool
)
