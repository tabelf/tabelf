...
func (cq *CommunityQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (cq *CommunityQuery) FirstIDX(ctx context.Context) uint64 {
...
// Returns a *NotSingularError when exactly one Community entity is not found.
...
// Returns a *NotSingularError when exactly one Community ID is not found.
// Returns a *NotFoundError when no entities are found.
func (cq *CommunityQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (cq *CommunityQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (cq *CommunityQuery) IDs(ctx context.Context) ([]uint64, error) {
	var ids []uint64
...
func (cq *CommunityQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := cq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (cgb *CommunityGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("entschema: CommunityGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CommunityGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{community.Label}
	default:
		err = fmt.Errorf("entschema: CommunityGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *CommunityGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("entschema: CommunityGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CommunityGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{community.Label}
	default:
		err = fmt.Errorf("entschema: CommunityGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *CommunityGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("entschema: CommunityGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CommunityGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{community.Label}
	default:
		err = fmt.Errorf("entschema: CommunityGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *CommunityGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("entschema: CommunityGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CommunityGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{community.Label}
	default:
		err = fmt.Errorf("entschema: CommunityGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CommunitySelect) Strings(ctx context.Context) ([]string, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("entschema: CommunitySelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CommunitySelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{community.Label}
	default:
		err = fmt.Errorf("entschema: CommunitySelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CommunitySelect) Ints(ctx context.Context) ([]int, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("entschema: CommunitySelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CommunitySelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{community.Label}
	default:
		err = fmt.Errorf("entschema: CommunitySelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CommunitySelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("entschema: CommunitySelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CommunitySelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{community.Label}
	default:
		err = fmt.Errorf("entschema: CommunitySelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CommunitySelect) Bools(ctx context.Context) ([]bool, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("entschema: CommunitySelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CommunitySelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{community.Label}
	default:
		err = fmt.Errorf("entschema: CommunitySelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
