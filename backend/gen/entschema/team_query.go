...
func (tq *TeamQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (tq *TeamQuery) FirstIDX(ctx context.Context) uint64 {
...
func (tq *TeamQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (tq *TeamQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (tq *TeamQuery) IDs(ctx context.Context) ([]uint64, error) {
	var ids []uint64
...
func (tq *TeamQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := tq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (tgb *TeamGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(tgb.fields) > 1 {
		return nil, errors.New("entschema: TeamGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := tgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tgb *TeamGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{team.Label}
	default:
		err = fmt.Errorf("entschema: TeamGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (tgb *TeamGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(tgb.fields) > 1 {
		return nil, errors.New("entschema: TeamGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := tgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tgb *TeamGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{team.Label}
	default:
		err = fmt.Errorf("entschema: TeamGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (tgb *TeamGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(tgb.fields) > 1 {
		return nil, errors.New("entschema: TeamGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := tgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tgb *TeamGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{team.Label}
	default:
		err = fmt.Errorf("entschema: TeamGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (tgb *TeamGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(tgb.fields) > 1 {
		return nil, errors.New("entschema: TeamGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := tgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tgb *TeamGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{team.Label}
	default:
		err = fmt.Errorf("entschema: TeamGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ts *TeamSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ts.fields) > 1 {
		return nil, errors.New("entschema: TeamSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ts.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ts *TeamSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{team.Label}
	default:
		err = fmt.Errorf("entschema: TeamSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ts *TeamSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ts.fields) > 1 {
		return nil, errors.New("entschema: TeamSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ts.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ts *TeamSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{team.Label}
	default:
		err = fmt.Errorf("entschema: TeamSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ts *TeamSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ts.fields) > 1 {
		return nil, errors.New("entschema: TeamSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ts.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ts *TeamSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{team.Label}
	default:
		err = fmt.Errorf("entschema: TeamSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ts *TeamSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ts.fields) > 1 {
		return nil, errors.New("entschema: TeamSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ts.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ts *TeamSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{team.Label}
	default:
		err = fmt.Errorf("entschema: TeamSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
